...
class Kazamata:
    ...
    def __init__(self, tipus: str, nev: str, ellenseg_nevek: List[str], vezér_nev: Optional[str], jutalom: Optional[str], uj_kartya: Optional[str] = None):
        self.tipus = tipus
        self.nev = nev
        self.ellenseg_nevek = ellenseg_nevek
        self.vezer_nev = vezér_nev
